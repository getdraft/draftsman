...
| ProductComponent | `catalog/engineering/product-components/` | [product-component.schema.yaml](../schemas/product-component.schema.yaml) | First-party runtime behavior used inside a SoftwareDeploymentPattern, including interfaces, environment configuration, `runtimeSpec` ports, and simple runtime dependencies when needed. |
