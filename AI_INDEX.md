...
| 01KSF29JTP-9HYA | OpenStack API Load Balancer | network_service | network-service, openstack, load-balancer, haproxy, iaas | HAProxy load balancer co-located on OpenStack controller nodes. Distributes inbound API and dashboard traffic across... | examples/catalog/network-services/network-service-openstack-api-lb.yaml |
...
| examples/catalog/network-services | 1 |
